        ...
        <div class="container flex justify-center items-center min-h-[100vh]">
            <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-2xl shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form action="{{ route('signin') }}" method="POST" class="space-y-6" action="#">
                    @csrf
                    <h5 class="text-3xl uppercase font-medium text-gray-900 dark:text-white text-center">Login</h5>
                    @if(session("success"))
                    ...
                    <button type="submit" class="w-full text-white bg-primary hover:bg-primary/80 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
