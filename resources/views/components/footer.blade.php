<section class="mb-[50px]">
    <div class="container flex justify-evenly">
        ...
        <div class="flex flex-col gap-[12px] w-[20%]">
            ...
            <div class="w-[196px] h-[51px] flex gap-2 items-center border border-[#BDBDBD] rounded-[60px] px-[20px]">
                <a href="" class="font-normal text-base leading-[22px] text-black">Email Address</a>
                <svg class="svg-icon w-[25px] rotate-45" viewBox="0 0 20 20" fill="#EB5757">
